import 'package:cell_req/200/ReportGeneration/api_list_dispose.dart';
import 'package:cell_req/200/ReportGeneration/api_list_requirments.dart';
                          ...
                          CustomElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              if (startDate == null || endDate == null) {
                                ...
                                downloadPDF(data, "nodal_requirement_list");
                              }
                            },
                            radius: 8,
                            textFontSize: 16,
                          ...
                          CustomElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              if (startDate2 == null || endDate2 == null) {
                                ...
                                downloadPDF(data, "nodal_dispose_list");
                              }
                            },
                            radius: 8,
                            textFontSize: 16,
