...
import './../ViewDetails/api_details.dart';
...
class _ApiDataListState extends State<ApiDataList> {
  ...
  Future<void> loadInitialData() async {
    ...
    details = await apiController.getDataListById(
        context, "get_register_cell_list", data);
        ...
        leading: GestureDetector(
          ...
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => CellFormHome()));
          },
        ),
      ),
      body: SafeArea(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            VerticalDivider(),
            buildCell("Cell Id.", flex: 2, color: Colors.white),
            VerticalDivider(),
            buildCell("Cell Name", flex: 2, color: Colors.white),
            VerticalDivider(),
